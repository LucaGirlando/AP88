...
const MEMBER_INFO = {
    Paci: {
        name: "Paci",
        image: "Paci.jpg",
        nicknames: ["SARDO VERO", "IL PADRINO", "IL BENEFATTORE", "COLUI CHE LA SPIEGA", "LO STOMACO DEBOLE", "ALEXEY STAKHANOV"],
        stats: { trips: 5, avg: 8.7, max: "9.5 (Barcellona)", best: "Barcellona 24/25" }
    },
    Girla: {
        name: "Girla",
        image: "Girla.jpg",
        nicknames: ["IL T-REX", "PITA ADVISOR", "ANTHONY MARTIAL", "EHI EWA, HAI PROGRAMMI STASERA?", "FACCIAMOLE SUDAREEEE STE CIPOLLEE", "CARLO CONTI"],
        stats: { trips: 5, avg: 9.0, max: "9.5 (Barcellona)", best: "Barcellona 24/25" }
    },
    Paga: {
        name: "Paga",
        image: "Paga.jpg",
        nicknames: ["ER FREGOLA", "IL BARISTA", "IL MEGAFONO", "RIGATONI, NO FUSILLI", "SI CON RISO SENZA LATTOSIO", "I BABIES JETLAGGATI"],
        stats: { trips: 5, avg: 8.6, max: "9.5 (Corfù)", best: "Corfù 2022" }
    },
    Bax: {
        name: "Bax",
        image: "Bax.jpg",
        nicknames: ["NICKI LAUDA", "IL PENGWIN", "LA ZECCA DI STATO", "DELUX", "PAPÀ V", "MARKETING CONSULTANT"],
    ...
    Chiara: {
        name: "Chiara",
        image: "Chiara.jpg",
        nicknames: ["LO GNOCCO", "BIG ROM", "LA PART-TIME", "AMMAN", "LORD FARQUAAD"],
        stats: { trips: 4, avg: 8.0, max: "8+ (Corfù)", best: "Corfù 2022" }
    },
    Ceci: {
        name: "Ceci",
        image: "Ceci.jpg",
        nicknames: ["@JACOGILA", "THE WEEKEND", "LA CAFONA", "LA RADIOLINA", "BUSIVI, BUSIVI"],
        stats: { trips: 4, avg: 8.4, max: "9+ (Barcellona)", best: "Barcellona 24/25" }
    },
    Gaia: {
        name: "Gaia",
        image: "Gaia.jpg",
        nicknames: ["LA LAVASTOVIGLIE", "LA POETESSA", "DORAEMON", "SI IL CAZZO"],
...
const TRIP_DATA = {
    ...
    puglia2023: {
        ...
        reports: [
            ...
            },
            {
                ...
                grade: "8",
                desc: {
                    it: "Un po’ sottotono rispetto agli altri anni forse anche grazie al fatto che arriva a pancia piena con un goal poco prima della partenza. La sua giornata tipo è: mi sveglio, mangio, rutto, cago e bestemmio, per poi ripetere questa sequenza fino a cena (ma ha anche dei difetti). Non ha più il fisico di una volta, però si merita mezzo voto in più per l’insalata di riso che è bastata a sfamare tutti gli abitanti di Alezio city.",
                    en: "A bit quiet compared to other years, perhaps because he arrives full with a goal shortly before departure. His typical day is: I wake up, eat, burp, shit, and curse, then repeat this sequence until dinner (but he also has flaws). He no longer has the physique of the past, but deserves half a grade extra for the rice salad that was enough to feed all the inhabitants of Alezio city."
                }
            },
            {
                name: "Paci",
            ...
            },
            {
                ...
                grade: "8",
                desc: {
                    it: "Abbastanza boy da stare nella macchina dei boys, ma non abbastanza da dormire nella dependance dei boys. Durante la serata alla Praja tenta il KO su un maranza che la stava palpando, ma purtroppo va a vuoto. Quando ne ha più bisogno e non ci sperava più, ecco pronto un contratto multimilionario dall’Al Nassr per duettare in attacco con Cristiano Ronaldo e poter pagare l’ultima cena senza chiedere aiuti al benefattore.",
                    en: "Boy enough to be in the boys' car, but not enough to sleep in the boys' outbuilding. During the night at Praja she attempts a KO on a maranza who was groping her, but unfortunately misses. When she needs it most and had lost hope, here comes a multi-million contract from Al Nassr to pair up with Cristiano Ronaldo in attack and be able to pay for the last dinner without asking for help from the benefactor."
                }
            }
        ]
    },
        ...
        reports: [
            ...
            },
            {
                ...
                desc: {
                    ...
                    en: "For the fourth year in a row he confirms as driver, consumes a bit too much fuel driving like a maniac and once, listening to Milano Testarossa, attempts a quadkill on the boys going straight at a curve. His typical day is characterized by: 3 hours in the car with max 5 different songs, at least one stop at Lidl/Plodine/Mumbaza, max 2 hours on the beach, watching the stars every night (without ever finding Jupiter and Saturn). Everything is reported at the end of the day to Maria who by now is more informed about Croatia than Paga. He acts as a dad to the other three boys, plus this year he replaces the names game with any card game possible. -0.5 for the double-cross of the drink 'offered' to Paga in the disco."
                }
            },
            {
                name: "Girla",
            ...
            },
            {
                ...
                desc: {
                    ...
                    en: "Uphill start for him after Ari's attempted murder with the air conditioning [yes, yes!] which caused him a day of stop. In the whole vacation he never touches the stove nor any dick, luckily in Monza at least four 2010 friends of his sister are waiting for him. During the whole trip he gets hyped for the stories of a random girl, too bad that on the last day he discovers she's the girlfriend of a famous Milanese singer (Duomo area). Impossible not to make scam purchases every vacation: 7€ juice on the roadside and 7€ Puff in the disco (Girla does not approve)."
                }
            },
            {
                name: "Ari",
    ...
    sardegna2026: {
        title: { it: "🇮🇹 Sardegna 2026", en: "🇮🇹 Sardinia 2026" },
        stats: { avg: 7.45, top: "9 (Gaia/Girla)", participants: 11, duration: "5 giorni", location: "Sardegna" },
        reports: [
            {
                name: "Chiara",
                ...
                grade: "7.5",
                desc: {
                    it: "Per la prima volta si fa tutto il precampionato con la squadra, senza cessioni improvvise.\nLa sua vacanza è un vorrei ma non posso, vorrei giocare a schiaccia 7, ma Girla la shotta per prima, vorrei giocare a Lupus , ma viene uccisa per prima, vorrei bermi una birra fresca, ma le faccio esplodere in freezer.\nPer fortuna ha un alleato, il suo materassino/sedia/amaca/ma che cazzo è?",
                    en: "For the first time she does the whole pre-season with the team, without sudden transfers.\nHer holiday is a \"I want to but I can't\", I want to play schiaccia 7 but Girla shottas her first, I want to play Lupus but she gets killed first, I want to drink a cold beer but I make them explode in the freezer.\nLuckily she has an ally, her air bed/chair/hammock/what the fuck is it?"
                }
            },
            {
                name: "Ceci",
            ...
            },
            {
                ...
                grade: "9",
                desc: {
                    it: "Mi sa che è nel Prime, ovunque si vada cascano tutti ai suoi piedi.\nPeccato che a lei freghi solo del malessere che la aspetta a casa.\nHa qualche tipo di allergia alle persone, dovendosi allontanare ogni tot, ma facendo un favore agli altri, dato che non la smette di cantare quella cazzo di canzoncina (non ce la faccio più…)\nA mani basse la migliore nella Settimana Enigmistica, ma pecca di superbia dopo aver fatto napola fino al 7 a scopone scientifico contro Girla, dicendo che non è tutto culo.\nMa ricordiamoci che: chi è fortunato nel gioco è sfortunato in amore…\nSI IL CAZZO",
                    en: "I think she is in her Prime, everywhere we go everyone falls at her feet.\nToo bad she only cares about the malessere waiting for her at home.\nShe has some kind of allergy to people, having to walk away every now and then, but doing others a favor, since she won't stop singing that fucking song (I can't take it anymore...)\nHands down the best in the Settimana Enigmistica, but sins of pride after making napola up to 7 in scopone scientifico against Girla, claiming it's not all culo.\nBut let's remember: lucky in the game, unlucky in love...\nSI IL CAZZO"
                }
            },
            {
                name: "Bax",
                ...
                grade: "7.5",
                desc: {
                    it: "Grazie ad un piccolo bonus alla firma, riesce a partire con la squadra con un giorno di ritardo.\nPurtroppo, a suo malgrado si ritrova in casa con 5 ragazze, diventando un’amio a tutti gli effetti. Pur di allontanarsi chiede a chiunque di andare a nuotare.\nRegge finché può, ma dopo 4 giorni in cui deve aspettare 2h per andare al bagno, è costretto a lasciare il ritiro in anticipo, purtroppo a lavoro (in uno dei due) hanno assolutamente bisogno di lui.",
                    en: "Thanks to a small signing bonus, he manages to leave with the team one day late.\nUnfortunately, to his regret, he finds himself in a house with 5 girls, becoming an \"amio\" to all intents and purposes. Just to get away, he asks anyone to go swimming.\nHe holds on as long as he can, but after 4 days of having to wait 2h to go to the bathroom, he is forced to leave the ritiro early, unfortunately at work (in one of the two) they absolutely need him."
                }
            },
            {
                name: "Paga",
                ...
                grade: "10:2",
                desc: {
                    it: "Dopo una lunga attesa la coppia si riunisce, andando a recuperare tutti i baci persi negli ultimi 6 mesi, i testimoni parlano di un suono costante, come il ticchettio dell’orologio da muro a casa di nonna, e vocine come ASMR su TikTok. Impossibile separarli (persino dal letto singolo).\nPaga viaggia sul filo di un RASOIO cercando di accontentare in tutti i modi la sua dolce metà.\nPurtroppo la velocità non è il loro forte (soprattutto la mattina e durante lo shopping), ma si rifanno con parecchie scarrozzate con la macchina, nonostante Paga stesse per perdere il ruolo di secondo guidatore causa Jet-Lag\n+1 voto per Yara che ha dovuto affrontare la barriera linguistica.\n-2 voti per Paga che è l’unico essere umano a cui bere alcol fa venire il mal di schiena.",
                    en: "After a long wait the couple reunites, going to recover all the kisses lost in the last 6 months, witnesses speak of a constant sound, like the ticking of the wall clock at grandma's house, and little voices like ASMR on TikTok. Impossible to separate them (even from the single bed).\nPaga travels on the edge of a RAZOR trying to please his sweet half in every way.\nUnfortunately speed is not their strength (especially in the morning and during shopping), but they make up for it with several rides in the car, despite Paga almost losing his role as second driver due to Jet-Lag.\n+1 grade for Yara who had to face the language barrier.\n-2 grades for Paga who is the only human being whom drinking alcohol gives back pain."
                }
            },
            {
                name: "Eugi",
                ...
                grade: "7",
                desc: {
                    it: "Con la sua moto ti raggiunge ovunque, tu non gli hai detto dove andrai, ma sei già sicuro che ad un certo punto lo vedrai spuntare da qualche angolo della spiaggia. Anche la sera fa la sua sporca figura saltando solo la trasferta a Porto Rotondo per infortunio.\nPurtroppo il lunedì è tosto per tutti e a lui è toccato pure il turno di notte…\nFarà pure smart working dalla spiaggia, ma quelle poche volte che lavora lo fa con autorità, cazziando per bene quelli del SOLE24ORE.",
                    en: "With his motorbike he reaches you anywhere, you didn't tell him where you are going, but you are already sure that at some point you will see him pop up from some corner of the beach. Even in the evening he does his job, only skipping the trip to Porto Rotondo due to injury.\nUnfortunately Monday is tough for everyone and he also got the night shift...\nHe might do smart working from the beach, but those few times he works he does it with authority, scolding those of the SOLE24ORE."
                }
            },
            {
                name: "Marti",
                ...
                grade: "8.5",
                desc: {
                    it: "Il Generale arriva direttamente dal fronte del Vietnam, aimè con parecchie ferite dopo l’ultimo attacco, ma con un’abbronzatura invidiabile.\nDa subito si scopre che non è in vacanza, ma è li per controllare che il naso di Paci non pippi sul culo di una Colombiana. Si concede solo una serata libera dove, da vera pugliese, si arma di borsa frigo e distribuisce da bere a tutti i discepoli nel parcheggio del country.\nDa buon Generale gestisce alla perfezione casa Pacifico, tra pulizie, lavastoviglie e schiscette.\nMale briscola chiamata e Make Your Memes.\n+1 voto per quelle frittatozze folli.",
                    en: "The General arrives directly from the Vietnam front, unfortunately with several wounds after the last attack, but with an enviable tan.\nRight away it turns out she's not on vacation, but is there to make sure Paci's nose doesn't sniff on a Colombian's ass. She allows herself only one night off where, like a true Pugliese, she cools down her cooler bag and distributes drinks to all the disciples in the Country parking lot.\nAs a good General she manages Casa Pacifico to perfection, between cleaning, dishwasher and schiscette.\nBad call at briscola chiamata and Make Your Memes.\n+1 grade for those crazy frittatozze."
                }
            },
            {
                name: "Girla",
                ...
                grade: "9",
                desc: {
                    it: "Der letzte tanz, in italiano: l’ultimo ballo.\nGirano voci che dopo il contratto con Amundi, sarà la sua ultima vacanza low-budget, ma non ci crediamo molto…\nIl Girlone pre partenza le prova tutte per integrarsi con la cultura tedesca e mantenere una carnagione chiara, tra crema 70+ e maglietta contro i raggi UV, ma nulla da fare, già il secondo giorno se spegnevi la luce riuscivi a vedere solo i denti. In camera ci sta solo la notte, forse perche tra tatami sul soppalco e cascate d’acqua dal condizionatore, si sente in cima alla montagna, mentre lui è uno da mare.\nIn cucina è una garanzia, tra carne trita e cipolle sudate al punto giusto, svolta due pranzi che sembravano non essere coperti in casa Pacifico.\nAll’agriturismo però sorprende tutti, forse, poco lucido a causa della quantità di cibo ingerita, decide di pagare 600 bombe e chiarire ancora una volta a tutti che lui fa finance.",
                    en: "Der letzte tanz, in English: the last dance.\nRumor has it that after the Amundi contract, this will be his last low-budget vacation, but we don't buy it...\nBefore departure, the Girlone tries everything to integrate with German culture and maintain a fair complexion, between 70+ sunscreen and a UV-ray shirt, but no luck: by the second day if you turned off the light you could only see his teeth. He is only in the room at night, perhaps because between the tatami on the mezzanine and waterfalls from the air conditioner, he feels on top of a mountain, while he is a sea guy.\nIn the kitchen he is a guarantee, between minced meat and sweated onions at the right point, he saves two lunches that seemed uncovered in Casa Pacifico.\nAt the agriturismo however he surprises everyone, perhaps not very lucid due to the amount of food ingested, he decides to pay 600 bombe and clarify once again to everyone that he does finance."
                }
            },
            {
                name: "Paci",
            ...
            },
            {
                ...
                grade: "50€",
                desc: {
                    it: "Poche storie, mangiare da Da Mimmo non è come mangiare da Giuliano nel classico mercoledì sera in quel di Lissone. Lui ci prova, ma sicuramente non viene aiutato dai gusti da under 12 scelti delle girls, senza consultare gli altri.\nSi parte con Yogurt, vagamente acido ma si va avanti, ci aggiungi un po’ di Dark Chocolate e ti accorgi che nella scodella si sta formando una strana miscela, guardi la vaschetta e vedi 2kg di Nocciotella, vabbè un po monotono mal lo prendi lo stesso, tanto poi con l’ultimo giusto stravolgi tutto sicuro, ci sarà un po’ di frutta, e invece no, c’è Ciucciuè, un Pistacchio Pistacchioso extra dolce.\nFortuna che costava solo 50€ dai",
...
function parseGradeToNumeric(gradeStr) {
    ...
    if (clean.endsWith("/10")) {
        clean = clean.replace("/10", "").trim();
    }
                ...
                tooltip: {
                    callbacks: {
                        label: function(context) {
                            const member = context.dataset.label;
                            const tripKey = tripKeys[context.dataIndex];
                            const report = TRIP_DATA[tripKey].reports.find(r => r.name === member);
                            return `${member}: ${report ? report.grade : context.parsed.y}`;
                        }
                    }
                }
            },
