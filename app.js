    ...
    sardegna2026: {
        ...
        reports: [
            ...
            },
            {
                ...
                grade: "10:2",
                desc: {
                    it: "Dopo una lunga attesa la coppia si riunisce, andando a recuperare tutti i baci persi negli ultimi 6 mesi, impossibile separarli (persino dal letto singolo). Il jet-lag rischia di far perdere a paga il posto di secondo guidatore oltre a causare la loro assenza in prima serata. Per fortuna tornano più forti e uniti di prima: i testimoni parlano di un suono costante, come il ticchettio dell’orologio da muro a casa di nonna, e vocine come ASMR su TikTok. Paga viaggia sul filo di un RASOIO cercando di accontentare in tutti i modi la sua dolce metà. Purtroppo la velocità non è il loro forte (soprattutto la mattina e durante lo shopping), ma si rifanno con parecchie scarrozzate con la macchina. +1 voto per Yara che ha dovuto affrontare la barriera linguistica. -2 voti per Paga che è l’unico essere umano a cui bere alcol fa venire il mal di schiena.",
                    en: "After a long wait the couple reunites, going to recover all the kisses lost in the last 6 months, impossible to separate them (even from the single bed). The jet-lag risks making Paga lose his spot as second driver as well as causing their absence on the first night. Luckily they return stronger and more united than before: witnesses speak of a constant sound, like the ticking of the wall clock at grandma's house, and little voices like ASMR on TikTok. Paga travels on the edge of a RAZOR trying to please his sweet half in every way. Unfortunately speed is not their strength (especially in the morning and during shopping), but they make up for it with several rides in the car. +1 grade for Yara who had to face the language barrier. -2 grades for Paga who is the only human being whom drinking alcohol gives back pain."
                }
            },
            {
                name: "Eugi",
