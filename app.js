    ...
    sardegna2026: {
        ...
        reports: [
            ...
            },
            {
                ...
                grade: "10:2",
                desc: {
                    it: "Dopo una lunga attesa la coppia si riunisce, andando a recuperare tutti i baci persi negli ultimi 6 mesi, i testimoni parlano di un suono costante, come il ticchettio dell’orologio da muro a casa di nonna, e vocine come ASMR su TikTok. Impossibile separarli (persino dal letto singolo). Paga viaggia sul filo di un RASOIO cercando di accontentare in tutti i modi la sua dolce metà. Purtroppo la velocità non è il loro forte (soprattutto la mattina e durante lo shopping), ma si rifanno con parecchie scarrozzate con la macchina, nonostante Paga stesse per perdere il ruolo di secondo guidatore causa Jet-Lag +1 voto per Yara che ha dovuto affrontare la barriera linguistica. -2 voti per Paga che è l’unico essere umano a cui bere alcol fa venire il mal di schiena.",
                    en: "After a long wait the couple reunites, going to recover all the kisses lost in the last 6 months, witnesses speak of a constant sound, like the ticking of the wall clock at grandma's house, and little voices like ASMR on TikTok. Impossible to separate them (even from the single bed). Paga travels on the edge of a RAZOR trying to please his sweet half in every way. Unfortunately speed is not their strength (especially in the morning and during shopping), but they make up for it with several rides in the car, despite Paga almost losing his role as second driver due to Jet-Lag. +1 grade for Yara who had to face the language barrier. -2 grades for Paga who is the only human being whom drinking alcohol gives back pain."
                }
            },
            {
                name: "Eugi",
